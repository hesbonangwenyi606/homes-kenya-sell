...
const PropertyModal: React.FC<PropertyModalProps> = ({ property, onClose, onFavorite, isFavorite, isLoggedIn, onSubmitInquiry }) => {
  ...
  const handleSubmitInquiry = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData((prev) => ({ ...prev, phone: '', message: `I am interested in "${property.title}" in ${property.location}.` }));
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <div className="flex flex-col lg:flex-row h-full max-h-[90vh]">
          ...
          <div className="lg:w-2/5 overflow-y-auto p-6 lg:p-8">
            ...
            <div className="flex gap-2 mt-4">
              ...
              <button onClick={() => { window.open('https://wa.me/254725604549', '_blank'); }} className="flex-1 flex items-center justify-center gap-2 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-colors">
